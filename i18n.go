...
var supplementalTranslations = map[string]map[string]string{
	"en": {
		...
		"restore_password_title":         "Unlock backup",
		"restore_password":               "Backup password",
		"restore_source":                 "Backup zip or vault.json",
		"delete_command_group_not_empty": "Delete the command group's commands and subgroups first.",
		"set_vault_password":             "Set a vault password (leave blank to use the system credential store): ",
		"migrate_vault_password":         "Set a vault password to migrate the legacy vault: ",
		"cloud_backup_help":              "Enter restore  |  d delete  |  Esc back",
		"backup_password":                "Backup password",
		"legacy_no_password":             "Legacy no-password backup: leave empty to use the original system credential",
		"legacy_vault_title":             "Unlock legacy backup",
		"legacy_vault_password":          "Legacy vault password",
		"delete_webdav_backup":           "Delete this remote backup?",
		"delete_help":                    "Enter/y delete  |  Esc/n cancel",
		"change_vault_password":          "Change vault password",
		"current_vault_password":         "Current vault password",
		"new_vault_password":             "New vault password (empty uses system credential store)",
		"confirm_vault_password":         "Confirm new vault password",
		"vault_password_mismatch":        "New vault passwords do not match.",
	...
	"zh": {
		...
		"restore_password_title":         "\u89e3\u9501\u5907\u4efd",
		"restore_password":               "\u5907\u4efd\u5bc6\u7801",
		"restore_source":                 "\u5907\u4efd zip \u6216 vault.json",
		"delete_command_group_not_empty": "\u8bf7\u5148\u5220\u9664\u8be5\u5206\u7ec4\u4e2d\u7684\u5feb\u6377\u547d\u4ee4\u548c\u5b50\u5206\u7ec4\u3002",
		"set_vault_password":             "\u8bbe\u7f6e vault \u5bc6\u7801\uff08\u7559\u7a7a\u5219\u4f7f\u7528\u7cfb\u7edf\u51ed\u8bc1\u5b58\u50a8\uff09\uff1a",
		"migrate_vault_password":         "\u8bbe\u7f6e vault \u5bc6\u7801\u4ee5\u8fc1\u79fb\u65e7 vault\uff1a",
		"cloud_backup_help":              "Enter \u6062\u590d  |  d \u5220\u9664  |  Esc \u8fd4\u56de",
		"backup_password":                "\u5907\u4efd\u5bc6\u7801",
		"legacy_no_password":             "\u65e7\u7248\u65e0\u5bc6\u7801\u5907\u4efd\uff1a\u7559\u7a7a\u4ee5\u4f7f\u7528\u539f\u7cfb\u7edf\u51ed\u8bc1",
		"legacy_vault_title":             "\u89e3\u9501\u65e7\u7248\u5907\u4efd",
		"legacy_vault_password":          "\u65e7 vault \u5bc6\u7801",
		"delete_webdav_backup":           "\u5220\u9664\u6b64\u8fdc\u7a0b\u5907\u4efd\uff1f",
		"delete_help":                    "Enter/y \u5220\u9664  |  Esc/n \u53d6\u6d88",
		"change_vault_password":          "\u4fee\u6539 vault \u5bc6\u7801",
		"current_vault_password":         "\u5f53\u524d vault \u5bc6\u7801",
		"new_vault_password":             "\u65b0 vault \u5bc6\u7801\uff08\u7559\u7a7a\u4f7f\u7528\u7cfb\u7edf\u51ed\u8bc1\u5b58\u50a8\uff09",
		"confirm_vault_password":         "\u786e\u8ba4\u65b0 vault \u5bc6\u7801",
		"vault_password_mismatch":        "\u65b0 vault \u5bc6\u7801\u4e0d\u4e00\u81f4\u3002",
		"vault_password_changed":         "Vault \u5bc6\u7801\u5df2\u4fee\u6539\u3002",
	},
}
